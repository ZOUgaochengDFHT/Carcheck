...
//    self.backgroundColor = SELFVIEWBACKGROUNDCOLOR;
...
//    _moreButton.backgroundColor = SELFVIEWBACKGROUNDCOLOR;
...
//    [_moreButton setTitleColor:EGOREFRESHTEXTCOLOR forState:UIControlStateNormal];
...
//    NSLog(@"setContentOffset :%f", self.contentOffset.y);
