//
//  ZGCCarBrandListTableViewCell.swift
//  Carcheck
//
...
typealias TapToVehicleTypeVCBlock = (carBrandListModel:ZGCCarBrandModel) -> Void
class ZGCCarBrandListTableViewCell: UITableViewCell {
